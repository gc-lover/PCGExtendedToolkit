...
enum class EPCGExABBlendingType : uint8
{
	...
	CopyTarget       = 7 UMETA(DisplayName = "Copy (Source)", ToolTip = "= B", ActionIcon="PCGEx.Pin.OUT_BlendOp"),
	CopySource       = 8 UMETA(DisplayName = "Copy (Target)", ToolTip="= A", ActionIcon="PCGEx.Pin.OUT_BlendOp"),
